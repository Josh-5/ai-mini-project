...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        "*** YOUR CODE HERE ***"
        self.values = util.Counter() # dictionary initialized to 0
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        """
        "*** YOUR CODE HERE ***"
        # Approximate Q-value using features -> sum(feature(s,a)*weight).
        # It was easier to think of it as a sum instead of two vectors
        q = 0
    ...
    def update(self, state, action, nextState, reward: float):
        ...
        """
        "*** YOUR CODE HERE ***"
        # Apply update weight formula: wi = wi + alpha*diff*feature(s,a)
